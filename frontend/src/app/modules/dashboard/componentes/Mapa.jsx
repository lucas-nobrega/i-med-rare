//import Cidades from "app/modules/localizacao/componentes/Cidades";
...
class Mapa extends React.Component {
    ...
    carregarMapa = () => {
        pacienteService.getPacientesByUF().then((resposta) => {
            console.log(resposta.array);
            this.setState({ aguardandoDados: true });

            for (var i = 0; i < resposta.length; i++) {
                resposta[i].uf = resposta[i].uf.toLowerCase();
            }
            
            this.setState({ pacientesByUF: resposta, 
               aguardandoDados: false 
            });
    ...
    isEstadoComDoencas = (uf) => {
      for (var i = 0; i < this.state.pacientesByUF.length; i++) {
         if(this.state.pacientesByUF[i].uf===uf) {
            return this.state.pacientesByUF[i].quant_paciente>0;
         }
      }
    }
    ...
    render() {
                ...
                >
                    <g>
                        <a
                            ...
                            id="to"
                        >
                            <path className={ this.isEstadoComDoencas('to') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
        ...
        S234.852,233.695,289.558,235.641z"
                        ...
                        <a
                            ...
                            id="ba"
                        >
                            <path className={ this.isEstadoComDoencas('ba') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c-0.546-1.725-5.396-6.079-0.026-7.175c-3.175,0.959-1.944-4.027,0.875-3.012C316.726,200.733,314.044,200.527,313.276,197.775z"
                        ...
                        <a
                            ...
                            id="se"
                        >
                            <path className={ this.isEstadoComDoencas('se') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        C413.545,202.212,407.055,193.721,408.561,191.735z"
                            ></path>
                            <path className={ this.isEstadoComDoencas('se') ? 'estadoComDoenca circle': 'estadoSemDoenca circle' }
        ...
        c-6.238,0-11.258-5.053-11.258-11.261C406.063,187.89,411.084,182.854,417.324,182.854z"
                        ...
                        <a
                            ...
                            id="pe"
                        >
                            <path className={ this.isEstadoComDoencas('pe') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c0.219,0.108-8.244,6.681-7.506,3.314C383.556,170.4,374.241,168.566,373.011,167.238z"
                        ...
                        <a
                            ...
                            id="al"
                        >
                            <path className={ this.isEstadoComDoencas('al') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c-3.668-2.261-7.998-3.769-11.201-6.342C410.615,172.646,412.751,171.359,413.953,169.018z"
                            ></path>
                            <path
                                className={ this.isEstadoComDoencas('al') ? 'estadoComDoenca circle': 'estadoSemDoenca circle' }
        ...
        c-6.241,0-11.263-5.052-11.263-11.259C425.16,173.816,430.182,168.763,436.423,168.763z"
                        ...
                        <a
                            ...
                            id="rn"
                        >
                            <path className={ this.isEstadoComDoencas('rn') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c1.532-5.847-12.654,1.78-5.424-8.683c2.545-3.67-6.302-0.808-6.711,0.725C410.121,144.013,407.217,139.151,404.698,138.795z"
                            ></path>
                            <path className={ this.isEstadoComDoencas('rn') ? 'estadoComDoenca circle': 'estadoSemDoenca circle' }
        ...
        c-6.209,0-11.26-5.037-11.26-11.261C419.567,112.837,424.618,107.798,430.827,107.798z"
                        ...
                        <a
                            ...
                            id="ce"
                        >
                            <path className={ this.isEstadoComDoencas('ce') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        C373.035,102.314,374.815,105.971,372.379,104.409z"
                        ...
                        <a
                            ...
                            id="pi"
                        >
                            <path className={ this.isEstadoComDoencas('pi') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        C328.176,198.748,327.409,180.727,320.781,185.478z"
                        ...
                        <a
                            ...
                            id="ma"
                        >
                            <path className={ this.isEstadoComDoencas('ma') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        C290.983,125.675,290.983,128.044,288.845,127.827z"
                        ...
                        <a
                            ...
                            id="ap"
                        >
                            <path className={ this.isEstadoComDoencas('ap') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        C221.814,36.458,223.334,38.417,225.198,39.089z"
                        ...
                        <a
                            ...
                            id="pa"
                        >
                            <path className={ this.isEstadoComDoencas('pa') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        C319.302,76.912,319.74,78.76,319.139,77.664z"
                        ...
                        <a
                            ...
                            id="rr"
                        >
                            <path className={ this.isEstadoComDoencas('rr') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        s-12.517-52.736-20.335-54.063C115.261,36.417,111.523,25.682,113.18,24.107z"
                        ...
                        <a
                            ...
                            id="am"
                        >
                            <path className={ this.isEstadoComDoencas('am') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c-8.601-4.381-16.61-8.981-26.088-11.05c-10.282-2.259-20.635-4.793-29.878-10.011C4.121,145.766,12.433,144.779,10.078,136.412z"
                        ...
                        <a
                            ...
                            id="ac"
                        >
                            <path className={ this.isEstadoComDoencas('ac') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c6.299-3.41-3.107-11.9-5.216-15.679c-0.52-0.918-3.588-4.655-3.629-5.957C1.642,150.174,6.612,151.968,3.656,148.545z"
                        ...
                        <a
                            ...
                            id="ro"
                        >
                            <path className= { this.isEstadoComDoencas('ro') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c-0.384-6.081-1.028-1.986-3.382-1.903C94.336,180.686,85.957,181.671,83.34,180.232z"
                        ...
                        <a
                            ...
                            id="mt"
                        >
                            <path className={ this.isEstadoComDoencas('mt') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        C143.581,176.618,141.937,174.714,142.237,173.962z"
                        ...
                        <a
                            xlinkHref="#mattogrossodosul"
                            className="estado"
                            name="Mato Grosso do Sul"
                            code="50"
                            id="ms"
                        >
                            <path className={ this.isEstadoComDoencas('ms') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c0.932-2.847,1.411-9.912,0.453-11.856c-0.165-0.331-3.52-7.232-2.547-8.108C186.306,297.688,182.334,299.415,183.198,294.536z"
                        ...
                        <a
                            ...
                            id="go"
                        >
                            <path className={ this.isEstadoComDoencas('go') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c-3.724-0.604,1.04-3.231,0.22-4.109c-1.89-1.916-4.382,1.756-3.588-3.012C239.602,274.627,237.055,273.038,237.768,270.519z"
                        ...
                        <a
                            ...
                            id="pr"
                        >
                            <path className={ this.isEstadoComDoencas('pr') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c-3.875-1.449-2.698-6.491-6.054-8.216C226.663,364.623,222.498,367.8,222.225,363.694z"
                        ...
                        <a
                            ...
                            id="sc"
                        >
                            <path className={ this.isEstadoComDoencas('sc') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        C276.085,411.866,233.534,382.918,231.029,383.959z"
                        ...
                        <a
                            ...
                            id="rs"
                        >
                            <path className={ this.isEstadoComDoencas('rs') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c-2.3-1.999-4.793-5.479-7.737-6.68c-3.478-1.367-5.615,5.145-9.052,0.821C189.168,418.854,190.332,418.032,191.236,416.881z"
                        ...
                        <a
                            ...
                            id="sp"
                        >
                            <path className={ this.isEstadoComDoencas('sp') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        C247.982,330.386,239.876,331.21,239.3,330.554z"
                        ...
                        <a
                            ...
                            id="mg"
                        >
                            <path className={ this.isEstadoComDoencas('mg') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c-4.708-0.353-5.53-1.613-9.858,0.631C262.993,300.562,262.336,299.274,262.881,297.305z"
                        ...
                        <a
                            ...
                            id="rj"
                        >
                            <path className={ this.isEstadoComDoencas('rj') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        C336.717,337.908,333.927,342.41,332.886,337.429z"
                            ></path>
                            <path
                                className={ this.isEstadoComDoencas('rj') ? 'estadoComDoenca circle': 'estadoSemDoenca circle' }
        ...
        c-6.211,0-11.263-5.054-11.263-11.264C343.831,323.634,348.883,318.613,355.094,318.613z"
                        ...
                        <a
                            ...
                            id="es"
                        >
                            <path className={ this.isEstadoComDoencas('es') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        c-1.64-0.274-3.202-0.768-4.736-1.451C368.819,311.297,369.424,309.055,367.119,308.834z"
                            ></path>
                            <path
                                className={ this.isEstadoComDoencas('es') ? 'estadoComDoenca circle': 'estadoSemDoenca circle' }
        ...
        c-6.212,0-11.263-5.049-11.263-11.261C370.654,289.777,375.705,284.723,381.917,284.723z"
                        ...
                        <a
                            ...
                            id="df"
                        >
                            <path className={ this.isEstadoComDoencas('df') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        C291.503,252.853,292.461,246.197,292.461,246.197z"
                            ></path>
                            <path
                                className={ this.isEstadoComDoencas('df') ? "estadoComDoenca circle": "estadoSemDoenca circle" }
        ...
        c-6.209,0-11.261-5.053-11.261-11.263C289.475,243.377,294.523,238.34,300.735,238.34z"
                        ...
                        <a
                            ...
                            id="pb"
                        >
                            <path className={ this.isEstadoComDoencas('pb') ? 'estadoComDoenca': 'estadoSemDoenca' }
                                stroke="#FFFFFF"
                                strokeWidth="1.0404"
                                strokeLinecap="round"
                                strokeLinejoin="round"
        ...
        C405.574,150.776,400.398,142.889,401.575,141.096z"
                            ></path>
                            <path
                                className={ this.isEstadoComDoencas('pb') ? 'estadoComDoenca circle': 'estadoSemDoenca circle' }
        ...
        c-6.208,0-11.257-5.036-11.257-11.262C422.54,138.647,427.589,133.597,433.797,133.597z"
                ...
                {!this.state.aguardandoDados && (
                    <div>
                        {this.state.pacientesByUF.map((estado, index) => (
                            <Tooltip
                                key={estado.uf}
                                placement="top"
                                isOpen={this.state[index] ? this.state[index] : false}
                                target={estado.uf}
                                toggle={() => this.toggle(index)}
                            >
                                {estado.nome}: {estado.quant_paciente} pacientes{" "}
                            </Tooltip>
                        ))}
                    </div>
                )}
